...
let msg = "chrome utils extension: yt.ts script loadeddd"
console.log(msg);
...
export function setYtRes(videoElement: HTMLVideoElement) {
...
/**
 * this is for youtube.com
 * yt sometimes tries to limit their bandwidth and auto select less than max resolution like 360p.
 * this fn is meant to prevent that
 * 
 * manipulate local storage entry to change resolution  
 * works best so far
 */
